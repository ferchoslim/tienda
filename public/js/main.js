...
var Core = function(options) {
  ...
  var runSideMenu = function(options) {
    ...
    var sbOnLoadCheck = function() {
      ...
      if ($('body.sb-top').length) {
        // If window is < 1280px wide collapse both sidebars and add ".mobile-view" class
    ...
    var sbOnResize = function() {
      ...
      if ($('body.sb-top').length) {
        // If window is < 1280px wide collapse both sidebars and add ".mobile-view" class
        if ($(window).width() < 1080 && !Body.hasClass('sb-top-mobile')) {
      ...
      // If window is < 1280px wide collapse both sidebars and add ".mobile-view" class
      if ($(window).width() < 1280 && !Body.hasClass('mobile-view')) {
        Body.removeClass('sb-r-o').addClass('mobile-view sb-l-m sb-r-c');
  ...
  return {
    init: function(options) {
      ...
      $("#copyright-year").text(dateNow.getFullYear());
    }
